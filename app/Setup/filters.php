...
namespace Menesu\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'Menesu\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Menesu\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Menesu\Theme\App\Setup\modify_excerpt_length');
